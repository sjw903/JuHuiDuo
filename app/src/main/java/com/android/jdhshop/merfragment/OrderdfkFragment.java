...
public class OrderdfkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mview = inflater.inflate( R.layout.fragment_orderdfk, container, false );
        init();
        return mview;
    }
    public void init(){
        listView = mview.findViewById( R.id.orderdfk_listview );
    ...
    private void postgetaddresslist(String search) {
        ...
        HttpUtils.post1( Constants.getOrderList, OrderdfkFragment.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
    ...
    private void postqxorder() {
        ...
        HttpUtils.post1( Constants.cancel,OrderdfkFragment.this, requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
