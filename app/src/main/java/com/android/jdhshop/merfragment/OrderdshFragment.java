...
public class OrderdshFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mview = inflater.inflate( R.layout.fragment_orderdsh, container, false );
        init();
        return mview;
    }
    public void init(){
        listView = mview.findViewById( R.id.orderdsh_listview );
    ...
    private void postgetaddresslist(String search) {
        ...
        HttpUtils.post1( Constants.getOrderList,OrderdshFragment.this, requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
    ...
    private void postqxorder() {
        ...
        HttpUtils.post1( Constants.cancel, OrderdshFragment.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
