...
public class OrderdfhFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mview = inflater.inflate( R.layout.fragment_orderdfh, container, false );
        init();
        return mview;
    }
    public void init(){
        listView = mview.findViewById( R.id.orderdfh_listview );
    ...
    private void postgetaddresslist(String search) {
        ...
        HttpUtils.post1( Constants.getOrderList, OrderdfhFragment.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
    ...
    private void postqxorder() {
        ...
        HttpUtils.post1( Constants.cancel, OrderdfhFragment.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
