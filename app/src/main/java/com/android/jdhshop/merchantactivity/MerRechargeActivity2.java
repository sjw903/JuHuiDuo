...
//    }
    ...
    private void getPayInfo() {
        ...
        HttpUtils.post(Constants.APP_IP+"/api/O2oVoucherOrder/getPayForm", MerRechargeActivity2.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                // 输出错误信息
                ...
                try {
                    ...
                    if (code.equals("0")) {
                        ...
                        if (jsonObject1 != null) {
                            ...
                            if (paytype.equals("wxpay")) {
                                ...
                                Runnable payRunnable = new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        PayTask alipay = new PayTask(MerRechargeActivity2.this);
                            ...
                            Toast.makeText(MerRechargeActivity2.this, "", Toast.LENGTH_SHORT).show();
                        }
                    }else if (code.equals("14")){
                        Intent intent = new Intent(MerRechargeActivity2.this,OrderListActivity.class);
                        intent.putExtra("type","4");
                        startActivity(intent);
                        Toast.makeText(MerRechargeActivity2.this, msg, Toast.LENGTH_SHORT).show();
                    } else{
                        Toast.makeText(MerRechargeActivity2.this, msg, Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getPayInfo1() {
        ...
        requestParams.put("pay_method", paytype);
        HttpUtils.post(Constants.recharge,MerRechargeActivity2.this, requestParams, new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                // 输出错误信息
                LogUtils.e("RE", "onFailure()--" + responseString);
