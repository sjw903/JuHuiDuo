...
public class T {
    ...
    public static void showShort(Context context, CharSequence message) {
        if(message==null)
            return;
        if(message.toString().contains("404")||message.toString().contains("Not Found")){
            return;
        }
        if (null == toast) {
    ...
    public static void showShortBottom(Context context, CharSequence message) {
        if(message==null)
            return;
        if(message.toString().contains("参数不正确")){
            return;
        }
        if(message.toString().contains("404")||message.toString().contains("Not Found")){
            return;
    ...
    public static void showLong(Context context, CharSequence message) {
        if(message!=null&&message.toString().contains("404")||message.toString().contains("Not Found")){
            return;
        }
        if (null == toast) {
            toast = Toast.makeText(context.getApplicationContext(), message, Toast.LENGTH_LONG);
    ...
    public static void show(Context context, CharSequence message, int duration) {
        if(message!=null&&message.toString().contains("404")){
            return;
        }
        if (null == toast) {
