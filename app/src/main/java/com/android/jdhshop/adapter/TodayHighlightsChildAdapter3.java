 ...
 * 说明：子适配器
 */
public class TodayHighlightsChildAdapter3 extends CommonAdapter<HaoDanBean> {
    SpannableString spannableString;
    Drawable drawable;
    DecimalFormat df=new DecimalFormat("0.00");
    public TodayHighlightsChildAdapter3(Context context, int layoutId, List<HaoDanBean> datas) {
