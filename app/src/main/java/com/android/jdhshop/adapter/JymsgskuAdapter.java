...
public class JymsgskuAdapter extends BaseAdapter {

    private Context context;
    private List<Jymsgbean.Item.oilPriceList> lists;
    private SubClickListener subClickListener;
    public int selectindex = 0;
    public JymsgskuAdapter(Context context, List<Jymsgbean.Item.oilPriceList> list) {
    ...
    public View getView(final int positiona, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHold.tv_type.setText( lists.get( positiona ).oilName );
