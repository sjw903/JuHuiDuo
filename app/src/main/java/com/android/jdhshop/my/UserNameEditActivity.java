...
public class UserNameEditActivity extends BaseActivity {
    ...
    protected void initData() {
        et_two.setFilters(new InputFilter[]{ new InputFilter.LengthFilter(10) });
        ...
        tv_title.setText(R.string.homepage_user_name);
    ...
    private void upload(String content) {
        RequestParams requestParams = new RequestParams("user_name", content);
        showLoadingDialog();
        HttpUtils.post(Constants.GET_ADD_USER_HOME, UserNameEditActivity.this, requestParams, new HttpUtils.TextHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                LogUtils.d("UserNameEditActivity upload onSuccess responseString = " + responseString);
