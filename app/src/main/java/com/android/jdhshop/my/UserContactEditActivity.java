...
public class UserContactEditActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        tv_title.setText(R.string.homepage_contact);
    ...
    private void upload(String content) {
        RequestParams requestParams = new RequestParams("contact", content);
        showLoadingDialog();
        HttpUtils.post(Constants.GET_ADD_USER_HOME, UserContactEditActivity.this, requestParams, new HttpUtils.TextHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                LogUtils.d("UserContactEditActivity upload onSuccess responseString = " + responseString);
                ...
                if (response.getIntValue("code") == 0) {
                    ...
                    intent.putExtra("contact", content);
