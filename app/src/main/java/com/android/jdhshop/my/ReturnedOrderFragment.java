...
public class ReturnedOrderFragment extends BaseLazyFragment {
    public static final String TAG = "ReturnedOrderFragment";
    ...
    private View view;
    public static ReturnedOrderFragment fragment;
    ...
    public static ReturnedOrderFragment getInstance() {
        if (fragment == null) {
            fragment = new ReturnedOrderFragment();
        }
        return fragment;
    }
    ...
    private void getWph(){
        ...
        HttpUtils.post(Constants.APP_IP+"/api/WphOrder/getList",ReturnedOrderFragment.this, params, new onOKJsonHttpResponseHandler<WphOrderBean>(new TypeToken<Response<WphOrderBean>>() {
        }) {
            @Override
...
//        默认空值，获取全部
        ...
        HttpUtils.post(Constants.GET_ORDER_LIST_NEW, ReturnedOrderFragment.this,params, new onOKJsonHttpResponseHandler<OrderGuestNewBean>( new TypeToken<Response<OrderGuestNewBean>>() {
        }) {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                showToast(responseString);
    ...
    private void getPdd(){
        ...
        HttpUtils.post(Constants.GET_PDD_ORDER, ReturnedOrderFragment.this,params, new onOKJsonHttpResponseHandler<PddOrderBean>( new TypeToken<Response<PddOrderBean>>() {
        }) {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                showToast(responseString);
    ...
    private void getJd(){
        ...
        params.put("type",MyOrderActivity.CURRENT_ORDER_TYPE);
        params.put("order_sn",MyOrderActivity.order_sn);
        HttpUtils.post(Constants.GETJD_ORDERLIST,ReturnedOrderFragment.this, params, new onOKJsonHttpResponseHandler<JdOrderBean>(new TypeToken<Response<JdOrderBean>>() {
        }) {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                showToast(responseString);
