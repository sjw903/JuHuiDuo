...
public class CheckUtil {
    ...
    public static boolean isApkInstalled(Context context, String package_name){
        ...
        String checker = p.getInstallerPackageName(package_name);
        LogUtils.d("CheckisApkInstalled:", "isApkInstalled: ");
        return true;
    }
    /**
     * 邮箱校验
     ...
     */
    private static final String REGEX_MOBILE1 ="(1[35678]\\d{9})";
