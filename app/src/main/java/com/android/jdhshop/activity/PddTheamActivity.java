...
public class PddTheamActivity extends BaseActivity {
        ...
        shopRecyclerAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (taobaoGuesChildtBean != null) {
                    Intent intent = new Intent(PddTheamActivity.this, PddDetailsActivity.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("goods", taobaoGuesChildtBean.getGoodsSign());
    ...
    private void getTbkListRequst() {
        ...
        requestParams.put("theme_id", id);
        if (getIntent().getExtras().getString("type") != null) {
            requestParams.put("list_id", list_id);
            requestParams.put("sort_type", id);
            requestParams.put("page", indexNum);
        }
        HttpUtils.post(getIntent().getExtras().getString("type") != null ? Constants.APP_IP + "/api/Pdd/getTopGoodsList" : Constants.APP_IP + "/api/Pdd/getThemeGoods", PddTheamActivity.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                showLoadingDialog();
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                try {
                    ...
                    if ("0".equals(jsonObject.getString("code"))) {
                        ...
                        if (getIntent().getExtras().getString("type") != null) {
                            JSONArray array = jsonObject.getJSONObject("data").getJSONObject("top_goods_list_get_response").getJSONArray("list");
                            JSONObject tempObj;
...
//                                double tem=(Double.valueOf(tempObj.getString("min_group_price"))-Double.valueOf(tempObj.getString("coupon_discount")))*Double.valueOf(df.format(Double.valueOf(tempObj.getString("promotion_rate"))/1000));
                                //tempObj.put("commission",df.format(  tem*SPUtils.getIntData(PddTheamActivity.this,"rate",0)/100));
                                tempObj.put("commission", tempObj.getString("commission"));
