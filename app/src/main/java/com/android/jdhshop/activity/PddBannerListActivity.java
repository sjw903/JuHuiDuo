...
public class PddBannerListActivity extends BaseActivity{
        ...
        shopRecyclerAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                if (taobaoGuesChildtBean != null) {
                    Intent intent=new Intent(PddBannerListActivity.this,PddDetailsActivity.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("goods", taobaoGuesChildtBean.getGoods_sign());
    ...
    private void getTbkListRequst() {
       ...
       /// temp.put("channel_type",getIntent().getExtras().getString("channel_type"));
        ...
        HttpUtils.post1(href+"", PddBannerListActivity.this,requestParams, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
                showLoadingDialog();
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                Toast.makeText(PddBannerListActivity.this, "失败", Toast.LENGTH_SHORT).show();
            }
