...
/**
 * Created by lifuzhen on 2017/4/14.
 */
public class CaiNiaoRadioGroup extends LinearLayout {
    ...
    public CaiNiaoRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }
    public CaiNiaoRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    private void init() {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            ...
            if (null!=button&&button.isChecked()) {
                mProtectFromCheckedChange = true;
                if (mCheckedId != -1) {
                    setCheckedStateForView(mCheckedId, false);
                }
     ...
     *
     */
   // See {@link android.R.styleable#LinearLayout_Layout LinearLayout_Layout
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == CaiNiaoRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == CaiNiaoRadioGroup.this
