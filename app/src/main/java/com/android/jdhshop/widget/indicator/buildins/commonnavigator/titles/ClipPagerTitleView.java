package com.android.jdhshop.widget.indicator.buildins.commonnavigator.titles;
...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    public OnPagerTitleChangeListener getmOnPagerTitleChangeListener() {
        return mOnPagerTitleChangeListener;
    }

    public void setmOnPagerTitleChangeListener(OnPagerTitleChangeListener mOnPagerTitleChangeListener) {
